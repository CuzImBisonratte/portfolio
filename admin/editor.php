        ...
        <div>
            ...
            <main>
                ...
                foreach ($pageConfig['images'] as $key => $image) {
                    ...
                    echo '<img src="/admin/pages/' . $_GET['page'] . '/images/' . str_replace(".JPG", ".webp", $image['src']) . '" alt="" onclick="mediaManager.click(\'' . $key . '\')">';
                    echo '<a class="image-delete" href="javascript:mediaManager.deleteImage(\'' . $key . '\')">';
                    ...
                    echo '</svg>';
                    echo '</a>';
                    echo '<a class="image-info" href="javascript:mediaManager.editMetadata(\'' . $key . '\')">';
                    echo '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">';
